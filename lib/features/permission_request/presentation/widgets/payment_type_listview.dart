...
class PaymentTypeListview extends StatefulWidget {
  const PaymentTypeListview({required this.onSelected, super.key});
  final void Function(String) onSelected;
  @override
  State<PaymentTypeListview> createState() => _PaymentTypeListviewState();
}

class _PaymentTypeListviewState extends State<PaymentTypeListview> {
  @override
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (state.permissionTypeId == permissionTypes[index].id)
